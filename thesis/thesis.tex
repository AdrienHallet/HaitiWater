...
\begin{document}
	...
	\chapter{Conclusion}
		...
		%TODO est-ce qu'on met les métriques, si oui quoi de plus ? -> De zolis graphs
		...
		\section{Métriques}
			...
			\begin{figure}[H]
					...
					\caption{Répartition des commits au fil du temps}
					\label{fig:graph_git}
			\end{figure}

			\begin{figure}[H]
					\includegraphics[width=\textwidth]{images/trello_stat}
					\caption{Nombre et type de cartes fil du temps}
