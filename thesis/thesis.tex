...
\begin{document}
	...
	\chapter{Introduction}
		...
		\subsection*{Objectif}
			...
			Le but final de ce mémoire est de délivrer une application à l'ONG Protos et aux acteurs de la distribution de l'eau à Haïti. Même si cette application ne sera peut-être pas directement utilisée sur le terrain, nous espérons qu'elle poura aider ces acteurs à créer une base applicative qu'ils pourront maintenir et développer afin de répondre à leurs besoins.
