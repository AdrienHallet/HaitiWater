...
\begin{document}
	...
	\chapter{Introduction}
		...
		\subsection*{Objectifs}
			...
			Le but final de ce mémoire est de délivrer un prototype d'application à l'ONG Protos et aux acteurs de la distribution de l'eau à Haïti. Nous visons un déploiement de cette base applicative sur le terrain, et espérons que des futures équipes de développement pourront travailler à sa maintenance et son évolution.
		...
		\subsection*{Contribution}
			...
			Nous avons également proposé un prototype d'application pour la gestion de l'eau potable à Haïti. Nous espérons qu'elle pourra servir de base de travail, permettant aux acteurs de terrain d'avoir un jour un outil les aidant dans leur travail quotidien et apportant une aide au développement national.
	...
	\chapter{Contexte}
		...
		\section{Gestion actuelle de la distribution d'eau en milieu rural}
			...
			\subsection*{Procédures actuelles}
				...
				Les comités fontaines, eux, sont composés d'un responsable fontaine, un secrétaire et un trésorier. Il sont en charge du bon fonctionnement et de la qualité du point d'eau, d'apporter les fonds au comité de l'eau et de gérer les éventuels conflits entre usagers ou les réparations nécessaires.
		...
		\section{Comparaison avec des outils existants}
			...
			Afin d'avoir une meilleure idée de ce à quoi devrait ressembler un logiciel de gestion de distribution d'eau, nous avons recherché des logiciels existants parmi les plus répandus afin d'identifier leurs similarités, forces et faiblesses.
	...
	\chapter{Analyse des besoins}
		...
		\section{Besoins non-fonctionnels}
			...
			\subsection*{Sécurité des données}
				...
				Dans le monde d'aujourd'hui, il est évident qu'une certaine attention doit être accordée à la sécurité d'une application web. En Haïti peut-être plus qu'ailleurs au vu du contexte décrit en section~\ref{sec:situation}, une attention particulière se doit d'être portée à la possibilité qu'un utilisateur malveillant ou non se connecte au système.
	...
	\chapter{Implémentation}
		...
		\section{Choix technologiques}
			...
			\subsection*{Choix du framework - Django}
				...
				\begin{itemize}
					...
					\item La documentation et l'aide sont de meilleure qualité. Les frameworks ont une communauté et une équipe de développement qui facilitent la compréhension du projet et la recherche d'aide via la documentation et les forums. Avantages qu'il est impossible d'égaler dans une équipe de trois personnes sur dix mois.
				\end{itemize}
		...
		\section{Interface utilisateur}
			...
			\begin{enumerate}
				...
				\item La zone utilisateur qui affiche les notifications et le nom de compte. En cliquant sur celui-ci, il est possible de se déconneter ou de modifier ses informations personnelles dans le menu déroulant.
				\item L'aide rapide, permettant de déclencher une visite de la page ouverte, qui présente brièvement les contrôles et leur utilité.
			\end{enumerate}
		...
		\section{Client}
			...
			%Pages : 4 à 5
			\subsection*{Gabarits, modularité et réactivité}
		...
		\section{Serveur}
			...
			\subsection*{Mapping Objet-Relationnel}
				...
				Dans la section \ref{sec:gest_donnee}, nous avons décrit comment a été créée la base de données et sa structure. Il nous reste à faire interagir notre serveur avec cette dernière. Pour cela, nous avons utilisé le Mapping Objet-Relationnel proposé par Django. Il effectue la connexion avec le serveur de base de données, et se charge d'y envoyer toutes les requêtes.
			...
			\subsection*{Requêtes}
				...
				La fonction principale du serveur est de répondre aux requêtes que lui envoie le client. On en compte trois types différents : les deux premières gèrent la représentation de l'information à l'utilisateur tandis que la dernière est en charge de l'information en elle-même.
	...
	\newpage
		Dans un souci d'économie, les versions papier n'incluent pas les annexes. Vous pouvez consulter la version électronique PDF complète en la téléchargeant via : \url{https://github.com/AdrienHalletUCL/HaitiWater/blob/master/thesis/thesis.pdf}.
	...
	%\chapter{Planning}
		...
		\includepdf[pages=1,pagecommand=\chapter{Planning (Google Sheet)}, offset=0 -3cm, scale=0.6]{images/gantt_simplified}
	...
	%\chapter{Wireframes}
		...
		\includepdf[pages=1,pagecommand=\chapter{Wireframes (Pencil)},offset=0 -3cm,width=\textwidth]{../documents/design/wireframes/hi-fi/wireframes_hifi_pencil.pdf}
