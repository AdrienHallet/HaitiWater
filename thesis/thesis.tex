	...
	\chapter{Organisation}
		...
		\section{Approche de travail}
			...
			\subsection*{Planification}
				...
				La figure~\ref{fig:simplified_gantt} présente une vue simplifiée du diagramme de Gantt sur lequel les modules implémentés (voir section~\ref{sec:cahier_des_charges}) sont placés sur une ligne temporelle en dessous de laquelle les grandes phases du mémoire ont été placées, ainsi que les deux versions majeures, \emph{alpha} et \emph{beta}, déployées et présentées à tous les acteurs du projet.
		...
		\section{Méthodologie}
			Garantir l'avancement, sans variation indésirable, de tout projet se fait par le biais d'une méthodologie. Il est important que cette méthodologie soit connue de chacun pour garantir un rôle et un suivi dans le travail. %TODO justifier apport méthodologie

			\subsection*{Agile}
				%TODO explication de notre variation
				% Scrum-like
				% sprint 1 semaine, venant de la réunion avec promoteurs, organisation autour de ça, rétrospective, planification, retours
