...
\begin{document}
	...
	\addcontentsline{toc}{chapter}{Résumé}
		...
		La gestion du réseau de distribution d'eau potable en Haïti ne dispose pas d'un système informatisé suffisant dans certaines parties du pays. Dans ce mémoire, nous allons exposer nos productions visant à proposer une application web palliant à ce problème. Le contexte haïtien et les défis à relever sont d'abod exposés afin de comprendre ce qui fait d'Haïti un environnement particulier pour le développement d'un tel système. Ensuite sont présentées nos idées, propositions et réalisations en justifiant les différents choix d'implémentation et de technologies. Nous abordons ensuite la validation de l'application et les retours d'utilisateurs nous ayant permis d'améliorer l'outil. Nous concluons ce texte par le futur de ce travail, les possibilités et nos espoirs pour l'application web \emph{HaïtiWater}.
		...
		%TODO est-ce qu'on donne le mot de passe ? Est-ce qu'on explique qu'on ne peut pas le donner car il y a des informations pseudo-sensibles dessus ?
