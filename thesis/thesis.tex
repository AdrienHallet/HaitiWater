	...
	\chapter{Organisation}
		...
		\section{Méthodologie}
			...
			\subsection*{Phases du mémoire}
				%TODO variations autour de l'implémentation agile
		...
		\section{Répartition des tâches}
			...
			\subsection*{Conception et implémentation}
				%TODO Separation of concerns, impact négatif sur l'apprentissage individuel, impact positif sur la puissance de travail,
