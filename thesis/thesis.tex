	...
	\chapter{Organisation}
		...
		\section{Approche de travail}
			...
			\subsection*{Planification}
				...
				\begin{description}
					\item[Mensuel] Au départ du mémoire, un plan général a été dressé. Au début, les inconnues (\emph{e.g.,} étendue du projet, fonctionnalités à implémenter) ont empêché de définir avec précision les productions et les dates butoires. Avec l'avancée du mémoire, nous avons pu estimer l'avancement et notre vitesse de travail. Les réunions avec Protos pour présenter nos deux plus grandes échéances, à savoir les versions alpha et beta de l'application internet, ont été l'occasion de refaire le point et reformuler les objectifs.
					...
					%TODO voir l'utilité d'un tableau de métriques sur Trello

				\end{description}

				%TODO changement de la planification, adaptation blablabla
				%TODO ligne du temps (gantt simplifié)
