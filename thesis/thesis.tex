	...
	\chapter{Analyse des besoins}
		...
		\section{Besoins fonctionnels}
			...
			\subsection*{Gestion des données}
				...
				%TODO Sébastien : voir la possibilité de mettre le schéma BDD s'il est encore lisible  ici(sinon référence et annexe)
