	...
	\chapter{Validation}
		...
		\section{Vérifications utilisateurs réels}
			...
			\subsection*{Méthodologie}
				...
				Afin d'introduire un minimum d'erreurs statistiques, la mesure de la satisfaction des utilisateurs a suivi un protocole établi avec l'expérience de nos promoteurs sur base d'un ancien travail~\cite{ref:reflecton}, de cours~\cite{ref:vanderdonckt_hci, ref:vanderdonckt_cscw} et recherches sur la satisfaction utilisateur~\cite{ref:usability_evaluation_tools, ref:ssi}.
