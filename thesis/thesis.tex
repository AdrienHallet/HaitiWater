...
\begin{document}
	...
	\chapter{Contexte}
		...
		\section{Gestion actuelle de la distribution d'eau en milieu rural}
			...
			\subsection*{Organisation générale}
				...
				Actuellement, Protos agit dans deux zones du pays, indiquées sur la figure \ref{fig:carte_haiti_color} : Nord-Ouest (région dite "Moustiques") en bleu et Centre-Est (région dite "Onde Verte") en vert. Celles-ci font partie des plus rurales, et ont été choisies car ce sont celles qui ont le plus besoin d'aide.
	...
	\chapter{Améliorations futures}
		...
		\section{Propositions}
			...
			%TODO quoi d'autre ? on va pas lister tout le backlog, si ?
	...
	\chapter{Conclusion}
		...
		D'après les premiers retours d'organisations haïtiennes, l'application reçoit un accueil positif de la part des comités haïtiens auxquels elle a été présentée. Nous entretenons beaucoup d'espoirs pour l'application, à commencer par notre désir de voir l'application utilisée et continuer à être développée au fil du temps grâce à la base applicative modulaire que nous avons mise en place.
		...
		%(Adrien) -> Je suis pas convaincu par mon dernier paragraphe, j'aimerais qu'on termine sur quelque chose de plus "grand"
			...
			\begin{table*}[H]
				...
				\begin{tabular}{@{}lllc@{}}
					...
					\multirow{2}{*}{Trello} & Nombre de cartes  & x  \\
						& & \\
					\bottomrule
					\multirow{2}{*}{Code} & Nombre de commits & x \\
						& Nombre de lignes de code (avec librairies) & \\
						& Nombre de lignes de code (sans librairies) & \\
					\bottomrule
				\end{tabular}
	...
	\appendix
		...
		\includepdf[pages=2-,pagecommand=\section*{},width=\textwidth]{../documents/requirements/Cahier_des_Charges.pdf}

		%TODO trouver un moyen d'include images/full_gant_1705.pdf correctement
