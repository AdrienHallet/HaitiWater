...
\begin{document}
	...
	\chapter{Analyse des besoins}
		...
		\section{Structure des données}
			...
			% TODO explain better figure, how we made it and what it says
			% Est-ce que je rentre dans les détails de ce qu'il y a dans le schéma ? Kim a l'air d'en avoir envie...
	...
	\chapter{Implémentation}
		...
		\section{Choix technologiques}
			...
			\subsection*{Choix du framework - Django}
				...
				\subsubsection*{Critères - [B]on, [M]oyen, [N]égatif}
					...
					\begin{description}
						\item[C] Complexité - Difficulté d'utilisation / apprentissage. \hfill \\
							...
							\end{figure}
					%(Kim) Quelle est la conclusion pour ce critère (?)
					...
					\item[Pe] Performance - Capacités du framework. \hfill \\
							Bien que moins importantes que dans une application critique (e.g.: aérospatial, banque), les performances sont mesurées en termes de temps de réponse pour une requête du client au serveur. Il peut être important de noter que, dans le cas d'Haïti, la performance sera importante due à l'instabilité des connexions Internet.
				...
				%TODO Adrien : explication du calcul (moi-même je comprends moyen)
			...
			\subsection*{DataTables}
				...
				%TODO : Kim demande ce que ça veut dire
	...
	\chapter{Validation}
		...
		\section{Vérifications utilisateurs réels}
			...
			\subsection*{Modifications apportées}
				...
				% La figure~\ref{fig:screen_sandbox_quick_help} présente un des multiples ajouts post-validation apportés à l'application. Nous avons vu dans la section précédente que la complexité de l'interface pouvait être sa faiblesse, ce qui nous a amenés à implémenter une fonctionnalité de \emph{visite}, concept existant déjà sur de nombreuses applications web. En appuyant sur le bouton d'aide rapide dans le coin supérieur droit de l'interface, l'utilisateur déclenche une série d'astuces qui présentent brièvement les contrôles disponibles sur la page.
				%
				% \begin{figure}[H]
				% 	\includegraphics[width=\textwidth]{images/screen_sandbox_table_quick_help.png}
				% 	\caption{Capture d'écran de l'aide rapide pour les contrôles des tables}
				% 	\label{fig:screen_sandbox_quick_help}
				% \end{figure}
				%
