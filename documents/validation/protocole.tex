...
\section*{Scenario 2 - Utiliser les tables}
    \begin{description}
        ...
        \item[Objectif] Imprimer la liste des tous les éléments (fontaines, kiosques, ...) du réseau de la zone \emph{Ouest} classées par volume de sortie total
    ...
    \subsubsection*{Tâches (30 minutes)}
        \begin{enumerate}
            ...
            \item Rendez-vous dans votre page de gestion et trouvez un moyen de filtrer les éléments pour ne conserver que ceux de la zone  \emph{Ouest}.
            \item Triez les éléments par volume décroissant.
            \item Imprimez les éléments en vous assurant d'avoir la liste complète affichée. Par défaut, les tables n'affichent qu'un nombre limité d'éléments. Vous pouvez vous arrêter une fois que le navigateur vous propose d'imprimer le bon document, il n'est pas nécessaire de l'imprimer physiquement.
        \end{enumerate}
