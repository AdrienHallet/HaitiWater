    ...
    \subsection*{Questionnaire}
        ...
        \subsection*{Usabilité}
            \begin{description}
                ...
                \item[U8] J'ai trouvé l'application très lourde à utiliser.
...
\section*{Scenario 2 - Utiliser les tables}
    \begin{description}
        ...
        \item[Objectif] Imprimer la liste des tous les éléments (fontaines, kiosques, ...) du réseau de la zone \emph{CAEPA Passe Catabois} classée par volume de sortie total
