...
% Liste exhaustive de tous les termes pouvant prêter à confusion
  \begin{description} %ToDo : trouver un moyen de display ça beau, je sais pas si c'est l'idéal. Aussi y'a pas moyen d'auto-sort par ordre alphabétique ?
    ...
    \item[Citizen science] Future amélioration de l'applicaiton permettant une participation active des citoyens à l'amélioration de la distribution d'eau potable en Haïti (\emph{e.g. : en rapportant des problèmes})
    \item[Scalable] Désignant la capacité d'un logiciel à s'adapter aux changements d'ordre de grandeur
    \item[Réseau]
    \item[Fontaine]
    \item[Kiosque]
    \item[Réservoir]
...
\begin{itemize}
  \item Possibilité de visionner tous les points d'eau de la zone et leurs informations (statistiques : utilisateurs, revenus,... et tickets le concernant)
  ...
  \item Possibilité de créer ou supprimer des compte utilisateur (gestionaire de fontaine, de zone ou technicien). %tricky les gestionnaires de zone qui créent des gestionnaires de zone
