...
class ProfileTests(TestCase):
    ...
    def test_view_profile_not_connected(self):
        self.client.logout()

        response = self.client.get("/profil/")
        self.assertEqual(response.status_code, 302)

    def test_view_profile_sub(self):
        self.client.login(username="user_zone", password="test")

        response = self.client.get("/profil/")
        self.assertEqual(response.status_code, 200)

    def test_view_profile_fountain(self):
    ...
    def test_view_profile_edit(self):
        response = self.client.post("/profil/editer/infos/", {
            "first-name": "new_test",
            "last-name": "new_test",
    ...
    def test_view_profile_edit_not_connected(self):
        self.client.logout()
    ...
    def test_view_profile_edit_sub(self):
        self.client.login(username="user_zone", password="test")
    ...
    def test_view_profile_edit_fountain(self):
        self.client.login(username="user_fountain", password="test")
